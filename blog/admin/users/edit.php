      ...
      <div class="app-main__inner p-5">
        <div class="app-page-title">
          <div class="page-title-wrapper">
            <div class="page-title-heading">
              <div>Update User <?php echo $user['username']; ?>
        ...
        <div class="content">
          <form action="edit.php" method="POST">
            ...
            <?php endif; ?>
            <input type="hidden" name="id" class="text-input-u" value="<?php echo $id; ?>">
            <div>
                  <label>Username</label><br>
                  <input type="text" name="username" class="text-input-u" value="<?php echo $username; ?>">

               </div>
               <div>
                  <label>Email</label><br>
                  <input type="text" name="email" class="text-input-u" value="<?php echo $email; ?>">
               ...
               <div>
                  <button type="submit" name="update_admin">Update User</button>
               </div>
